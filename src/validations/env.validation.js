...
const envVarSchema = joi
  .object({
    ...
    JWT_ACCESS_EXPIRATION_MINUTES: joi.number().positive().default(60),
    JWT_REFRESH_EXPIRATION_DAYS: joi.number().positive().default(2),
    ...
    TRUST_PROXY: joi.alternatives().try(joi.boolean(), joi.string()).default(false),
  })
  .unknown();
